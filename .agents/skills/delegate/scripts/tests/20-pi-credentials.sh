...
echo 'Check the sandbox.credentials.envVars block in the harness'
echo 'settings, and whether the sandbox settings file parsed at all --'
echo 'an invalid one can be discarded wholesale, leaving the sandbox'
echo 'wide open in some contexts and enforced in others.'
exit 1
